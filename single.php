        ...
        <div class="client-story-main-content">
            ...
            <div class="gb-story-content">
                    ...
                    <div class="gb-story-content-title-bottom-section">
                        ...
                        ?>
                        <img src="<?php if($client_auther_image){echo $client_auther_image; } ?>">
                        <div class="gb-story-content-title-bottom-section-title">
                            <p><?php if($client_auther_name){echo $client_auther_name; } ?></p>
                            <p><?php if($client_auther_description){echo $client_auther_description; } ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="contact-form-box" id="contact-us">
                    <div class="description-title">
                        ...
                        <div class="description-title-image" style="background-image: url(http://localhost:8080/wordpress/doondook/wp-content/uploads/2022/01/services.svg);"></div>
            ...
            <div class="card">
                <div class="contact-form-box" id="contact-us">
                    <div class="description-title">
                        ...
                        <div class="description-title-image" style="background-image: url(http://localhost:8080/wordpress/doondook/wp-content/uploads/2022/03/image-13.png);"></div>
                        <div class="description-title-text">
